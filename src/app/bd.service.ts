  ...
  public publicar(publicacao: any): void {
    ...
    firebase
      ...
      .then((resposta: any) => {
        ...
        //storage guarda as ibagens
        //child é o caminho do bb
        firebase
          .storage()
          .ref()
          .child(`imagens/${nomeImagem}`)
          .put(publicacao.imagem)
          //put tem retorno, é http
          // on é um listener que acompanha o status do carregamento
          .on(
            firebase.storage.TaskEvent.STATE_CHANGED,
            // stateChanged acompanha e guarda o status do andamento de upload
